...
\begin{description}
 ...
 \item[makeall\_rest] hlavní spouštěcí script pro sestavení kapitoly 7~a~8.
...
Uživatel by měl mít také dostatečné znalosti jazyka bash aby~mohl V~případě potřeby upravit scripty.
...
\begin{itemize}
 ...
 \item Posledním krokem ke kterému scripty navedou je pak nastavení programu grub. Uživatel musí zadat /dev adresu disku, na kterém se nachází LFS např. sdb sda. GRUB poté vygeneruje soubor /boot/grub/grub.cfg potřebný pro zavedení jádra systému.
\end{itemize}
