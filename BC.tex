...
\end{Verbatim} 
    \end{codeframe}
nyní je dobré stáhnout a~překopírovat skripty LFS by bash scripts. Nejjednodušším způsobem je stáhnutí skriptů pomocí verzovacího systému git. Repozitář můze obsahovat změny, které by mohly udělat návod nefunkčním, proto je třeba změnit branch na tag BCv6.8, na který návod sedí.    \begin{codeframe} 
\begin{Verbatim}{frame=single} 
cd ~/
