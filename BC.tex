...
Dostupné pouze na DVD jako soubor LFS.7z (TODO doplnit bytes)\\

Obraz disku je určen pro program VirtualBox. Pro~použití stačí založit nový virtuální stroj \it{NEW -> vybrat název -> velikost RAM -> zvolit existující disk a~přidat disk LFS.vdi}\\
...
Spuštění grafického serveru příkazem \it{startx}.
