...
\b{B}ourne \b{A}gain \b{SH}ell je standardní interpret příkazů v Linuxu založený na Bourne shell. Funguje jako rozhraní mezi uživatelem a systémem
%##########
%###TODO###
%##########
...
\subsubsection{Smičky podmínky apd,...}
\subsubsection{Funkce a pole}
